...
var SignUpButton_exports = {};
__export(SignUpButton_exports, {
  SignUpButton: () => SignUpButton
});
module.exports = __toCommonJS(SignUpButton_exports);
var import_react = __toESM(require("react"));
var import_utils = require("../utils");
var import_withClerk = require("./withClerk");
const SignUpButton = (0, import_withClerk.withClerk)(({ clerk, children, ...props }) => {
  const { afterSignInUrl, afterSignUpUrl, redirectUrl, mode, ...rest } = props;
  children = (0, import_utils.normalizeWithDefaultValue)(children, "Sign up");
  const child = (0, import_utils.assertSingleChild)(children)("SignUpButton");
  const clickHandler = () => {
