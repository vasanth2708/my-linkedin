...
const withNormalizedClerkUrl = (req) => {
  ...
  const host = getFirstValueFromHeader(req, import_backend.constants.Headers.ForwardedHost);
  const protocol = getFirstValueFromHeader(req, import_backend.constants.Headers.ForwardedProto);
  const port = getFirstValueFromHeader(req, import_backend.constants.Headers.ForwardedPort);
